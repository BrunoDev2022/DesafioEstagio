...
<html lang="en">
  <head>
    ...
    <title> Esclusao de produto</title>
  </head>
  <body>
  ...
  ?>
      ...
      <div class="container">
          <div class=row>
              ...
              <form  name="acao" action="scrip_excluir.php" method="POST">
    ...
    <input type="text" class="form-control" name="qtd_estoque"  value="<?php echo $linha['qtd_estoque'];?>" >
              ...
              <div class="mb-3">
    <label for="qtd_estoque">Id do produto</label>
    <input type="text" class="form-control" name="id_estoque"  value="<?php echo $linha['id_estoque'];?>" >
              </div>
              <label for="qtd_estoque">digite o id do produto para confirma exclusão</label>
